...
function bseoni_bulk_quick_noindexer(){
    ...
    echo '<div style="display:none !important;">' . get_post_meta( get_the_ID(), 'bseoni_bulk_noindexer', true ) . '</div>'; 
    echo '<div style="display:none !important;">' . get_post_meta( get_the_ID(), 'bseoni_bulk_nofollow', true ) . '</div>'; 
}
...
function bseoni_bulk_quick_noindexer1(){
	 echo '<div style="display:none !important;">' . get_term_meta(get_queried_object()->term_id, 'bseoni_bulk_noindexer', true) . '</div>';
